<x-guest-layout>
    ...
    <div class="relative min-h-screen flex items-center justify-center bg-gray-950 overflow-hidden">
        ...
        <div class="relative z-10 w-full max-w-[420px] flex flex-col gap-5 p-4">
            ...
            <div class="bg-[#0b0d17]/80 backdrop-blur-md rounded-xl p-8 shadow-[0_0_40px_rgba(139,92,246,0.15)] border border-purple-500/20 relative overflow-hidden">
                ...
                <h2 class="text-lg font-bold text-white mb-1 relative z-10">Selamat Datang Kembali!</h2>
                <p class="text-xs text-indigo-200/60 mb-6 relative z-10">Silakan masuk untuk mengelola sistem.</p>
                ...
                <form method="POST" action="{{ route('login') }}" class="space-y-4 relative z-10">
                    ...
                    {{-- Submit Button --}}
                    <button type="submit" 
                        class="w-full mt-2 bg-gradient-to-r from-purple-600 to-indigo-600 hover:from-purple-500 hover:to-indigo-500 text-white font-bold text-xs py-3 rounded-lg transition-all shadow-[0_0_20px_rgba(139,92,246,0.3)] hover:shadow-[0_0_25px_rgba(139,92,246,0.5)] flex justify-center items-center gap-2 group">
                        MASUK KE SISTEM 
