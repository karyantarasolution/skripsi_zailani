        ...
        @if(Auth::user()->isAdmin())
            ...
            <div class="relative">
                ...
                <div x-show="openLaporan" x-collapse class="mt-1 space-y-1 ml-4 pl-3 border-l border-purple-500/20">
                    ...
                    <a href="{{ route('admin.laporan.stok') }}" target="_blank" class="sidebar-item text-xs">6. Laporan Stok</a>
                    <a href="{{ route('admin.laporan.retur') }}" target="_blank" class="sidebar-item text-xs">7. Laporan Retur</a>
                </div>
            </div>
